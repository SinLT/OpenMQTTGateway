...
#define WifiManager_password            "12345678" //this is going to be the WPA2-PSK password for the initial setup access point
...
#endif
char mqtt_user[parameters_size] = "Chindeo"; // not compulsory only if your broker needs authentication
char mqtt_pass[parameters_size] = "P@ssw0rd"; // not compulsory only if your broker needs authentication
char mqtt_server[parameters_size] = "10.0.0.23";
...
#define led_R             GPIO_NUM_34
#define led_G             GPIO_NUM_35
#define led_B             GPIO_NUM_32
#define key_toilet        GPIO_NUM_36
#ifndef led_receive
#  ifdef ESP8266
